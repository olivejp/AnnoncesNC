...
public class AnnoncesSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    /**
     * Principales actions menées pendant la synchronisation
     * -Envoi des annonces enregsitrées hors ligne et pas encore envoyées
     * -Suppression des annonces de l'utilisateur qu'il aurait pu faire hors ligne
     *
     * @param account    Compte avec lequel on va lancer la synchro
     * @param extras     Bundle vide
     * @param authority
     * @param provider
     * @param syncResult
     */
