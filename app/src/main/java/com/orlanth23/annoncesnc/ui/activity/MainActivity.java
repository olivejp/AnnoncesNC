...
import com.orlanth23.annoncesnc.ui.fragment.CardViewFragment;
import com.orlanth23.annoncesnc.ui.fragment.MyProfileFragment;
import com.orlanth23.annoncesnc.ui.glide.GlideApp;
import com.orlanth23.annoncesnc.utility.CircleTransform;
...
public class MainActivity extends CustomCompatActivity implements InterfaceProfileActivity, NoticeDialogFragment.Listener, CustomUserSignCallback, CustomUnregisterCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayNameTv = navHeader.findViewById(R.id.nav_header_display_name);
        emailTv = navHeader.findViewById(R.id.nav_header_email);
        profileImage = navHeader.findViewById(R.id.nav_img_profile);
    ...
    public void refreshProfileMenu() {
        if (CurrentUser.getInstance().isConnected()) {
            ...
            GlideApp.with(this).load(CurrentUser.getInstance().getPhotoUrlUTI())
                    .thumbnail(0.5f)
                    .apply(RequestOptions.circleCropTransform())
                    .transform(new CircleTransform(this))
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                    .into(profileImage)
                    .onLoadFailed(getResources().getDrawable(R.drawable.ic_person));
